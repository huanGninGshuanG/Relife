package com.hfad.relife.toss.custom;
...
import com.hfad.relife.Util.LogUtil;
...
public class StereoView extends ViewGroup {
    ...
    public StereoView toss(){
        if(!mScroller.isFinished()){
            mScroller.abortAnimation();
            LogUtil.m("Accomplished by force");
        }
        if(!isSliding) toNextAction(standerSpeed*10);
        return this;
    }
}
